...
for the target repository, preserve pillar boundaries and architecture decisions already documented in `AGENTS.md` and the Architecture Doc.
...
- if UX/UI or architecture **solution** design is still needed, stop and
  ...
  a design skill (for example design/product-design);
